...
- **`open-items.md`** holds what is open at group level; **`questions.md`** is the asking surface.
...
word, which makes this a register pass rather than a reading exercise — the method `questions.md` already
