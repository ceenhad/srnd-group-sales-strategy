...
| **Q23** | How does sensing relate to SRND Solutions? | **Neither — SRND Solutions is stale and is dropped.** It was named before this work existed and was never defined. *So the group is **six brands, not seven-in-waiting**, `open-items.md`'s go-to-market question retires unanswered rather than unresolved, and `CLAUDE.md` needs its mention removed — the steering document currently tells every reader a further own-made line is in development* | 2026-08-16 |
