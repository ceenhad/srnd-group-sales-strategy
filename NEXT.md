...
Two founders, a business that has to keep running, and no marketing department. There is no capacity for
a programme of projects, and a plan that assumes one is a plan that doesn't happen.

So this is **a parallel path, not a phase.** The strategy rides on work already in flight, and the
by-products of ordinary business do most of the strategic work. One test governs everything below:

> **Does this ride on something already happening, or does it need someone to stop doing something else?**
...
- **Cheap addition when convenient:** a reflection-point calculator — geometry only, and the obvious gap in
  the current set.
- Rides on: development already happening.
...
- **Smallest next move:** thank the £500k dealer properly, in person, naming the number and the people who
  did the work. Nothing to build, and it is the single highest-value thing on this page relative to effort.
...
- **Light Walls.** Being worked separately. **And the archive now records why it needs to be**
  ...
  **stopped**, with the residual Protopixel position invoiced across to SRND in March 2026. Over half its revenue
  ...
  - **▲ It has landed — reviewed 2026-08-15 (read-only, in the LWCP repo).** LWCP's architecture and
