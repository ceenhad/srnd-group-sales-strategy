...
- **There is no "long tail to service cheaply."** A small order in one brand is not a low-value
  account; it's the opening of a group relationship. We don't triage dealers by any single brand's
  order size.
