...
| **PR-7** | Three problems means three doors | Repo (`../group-strategy/buyer-journey.md`) | Three pathway files; the hook set's structure | Q50 taken to its conclusion: if the **system** is the product, the door may be the **room**, not the panel | **challenged** — Q50 settled that panels do not rank; it did not settle that three doors is the right decomposition, and I assumed it did |
