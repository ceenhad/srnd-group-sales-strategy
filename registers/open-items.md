...
*Cut back on 2026-08-20. **This file had grown to 838 lines of dated session narrative with 9 table rows and no
IDs** — a diary, not a register. What was removed: the 2026-07-31 stress test and its follow-ups, the distribution
history (superseded by `../evidence/archive-findings.md`), *"the direction set 2026-08-14"* and its four
