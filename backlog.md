...
| XS-5 | Decide | **Price the services and publish the list.** ~~Only £500 Pro Design carries a price today~~ — **corrected 2026-08-15 (finding 31): £672,915 of services has been invoiced across fifteen years and the prices are in it**, including *Acoustic Treatment Design Service — Basic* at £3,000 and *Sound Isolation Design Project* at £7,500, plus install support at £4,800/day and 41 design engagements at a median of £2,400. **So this is ratifying a history, not setting a number.** Only **acoustic verification** has no precedent at all | — | Small — read and ratify | ready | `group/13-standards-decision-sheet.md` session 2, `archive-findings.md` finding 31 |
