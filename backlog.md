...
| SYS-6 | Fetch | **Fill the seven blank assignment rows** in `group/10-tasks.md` — lead-time follow-up, defending against a competitor, market intelligence, product feedback, competitor tracking, dealer marketing support, product launch. **Ask who does each; write it in.** Earlier drafts read these blanks as gaps in the business and drew findings from them — struck as unverified inference | owner, relationship | Minutes | ready | `group/10-tasks.md` |
| SYS-7 | Fetch | **Record who does the marketing tasks**, now that they are inventoried for the first time — competitor tracking, discoverability, dealer marketing support, product launch, measurement. The register has blanks against these; ask and write the answers in before drawing any conclusion from them | — | A pass | ready | `group/10-tasks.md` |
