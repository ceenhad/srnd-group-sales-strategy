...
| JNY-5 | Do | Fold the 2023 archive in: the two stage-boundary signals (contact; proposal request) into the gateway table, the four awareness sub-goals as the test for awareness pieces, the *Purchase Events* tree into the schema's doubt fields, and RAPS 2023 dusted off as the working process for the US conversion (US-4). Clarify the Apex-Tech UK vs Apex-Tech (US) naming first | Neil (confirmations) | Small | ready | `group/2023-buyer-journey-archive.md` |
