...
- **NOT A TENSION — `Q26`/`Q65`: the expansion is permitted, C-ATS is the standard form, the
...
**Permitted — `Q26`/`Q65`.** *C-ATS is the standard form, so "throughout" is the only part to change.*
