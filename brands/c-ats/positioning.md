...
> integrator. **Acoustics at this level usually
 ...
 *( — corrected 2026-08-19, `C1.27`: that figure appears once in the ledger, a 2023 consulting line.
...
- **Shallow depth is a deliberate commercial decision, not a spec boast.** The cost that matters is
 ...
 panels. Depth removed is space returned to the client. **Struck — `Q63`, 2026-08-19.** *"A number means little to most buyers"* was unsourced buyer
...
- **It applies to any room with these problems, not a named space.** Small rooms have all three;
 large rooms are reverberation-dominated. **The commercial
 ...
 **The posture, not a band** *(`C1.38`, replaced and then evidenced 2026-08-19)*: — unmeasured, and `Q64` requires a named comparison to be measured.
 **What is observable, and now sourced from four fetched sites**
 (`../../evidence/2026-08-19-acoustics-competitor-scan.md`): **GIK publishes prices and sells direct; RPG sells
 through representatives; Artnovion shows no public price and runs a partners area. C-ATS is trade-only and
 gated.** *Axis `A5`. **The margin clause is deliberately not here** — `C1.36` is still `drafted`.*
...
**State the problem plainly** — three problems, three solutions. **The positioning is independence: a system the integrator runs without hiring the author**
