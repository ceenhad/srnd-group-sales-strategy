...
| **C1.4** | Most competitors sell acoustics on science and jargon | `brand` | **confirmed 2026-08-18 — and CHALLENGED ON EVIDENCE 2026-08-19.** *Four competitors researched from their own pages (`../../evidence/2026-08-19-acoustics-competitor-scan.md`) and **none does this.** GIK does the opposite — one plain figure, free expert advice, a 3D designer. Primacoustic is rigorous and legible. RPG publishes data sheets. Artnovion leads on "engineered for performance designed for emotion".* **Recorded as evidence against the row, not acted on** (`../../CLAUDE.md`: new data lands against a decision, it does not reopen the reasoning). **`C1.14` names a real category charge — products overclaiming "diffusion" that was really scattering; `C1.4` generalises it to *most* competitors, and the generalisation is what four out of four do not support.** **↻ Revised the same day, after Neil ruled the tier out** (`PR-19`: *"if it's sold openly online or for studios it's almost certainly not for us"*). **Three of those four were the wrong tier.** *On the real tier — **Keith Yates**, **Officina Acustica**, **QuestAI** — the row is not unsupported, it is **mis-worded**: **they do not sell jargon, they write the science.** Peter Aylett co-leads Officina Acustica and **chaired the rewrite of the RP22 recommended practice**; Gerry Lemay is President of QuestAI and **founder-director of the HAA**. **And `C1.14`'s "diffusion" charge now has a named instance in the real tier.*** → `Q74` |
...
| **C1.15** | The 3 Rs is a deliberate, honest marketing device — plain-spoken against a jargon-heavy category | `brand` | confirmed 2026-08-18 |
