...
| **C1.18** | Three problems stated, three solutions given | `brand` | **confirmed as description, not as structure.** `PR-7` broken (`Q71`) — the three problems are real and the *way in* is the room, not three doors |
...
| **C2.9** | Optimised for the integrator and no one else — not acousticians, studio designers or end clients | `brand` | drafted |
...
| **C5.9** | State the problem plainly — three problems, three solutions | `brand` | **holds as copy; the structure it implied does not.** `PR-7` **broken 2026-08-19** (`Q71`): **one way in, the room.** *Naming three problems plainly is right — that is `C1.15`, the 3 Rs as an honest device. What breaks is treating them as **three routes to market**: three pathway files and the hook set collapse to one* |
