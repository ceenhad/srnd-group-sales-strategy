...
| **C1.4** | ~~Most competitors sell acoustics on science and jargon~~ | `brand` | **SUPERSEDED 2026-08-19 by `C1.39`** (`Q74`). *Confirmed 2026-08-18, then challenged on evidence and re-challenged when the tier was corrected: **the real tier does not sell jargon, it writes the science** — Aylett chaired the RP22 rewrite, Lemay founded the HAA, Keith Yates publishes psychoacoustic explanation and a proprietary scorecard.* **The row is kept, not deleted**, because the whole positioning contrast rested on it and the work built on it has to be findable |
...
| **C1.15** | The 3 Rs is a deliberate, honest marketing device — ~~plain-spoken against a jargon-heavy category~~ | `brand` | **confirmed 2026-08-18; the second clause superseded 2026-08-19** (`C1.39`). *The device is real and `Q70` confirmed the 3 Rs **is** the design system. **What it is not is a contrast against jargon** — the tier that competes authors the science. The 3 Rs earns its place by making the system specifiable by a dealer, which is `C1.39`* |
...
| # | The claim | Kind | Status |
|---|---|---|---|
| **C1.17** | ~~Almost every competitor sells acoustics by burying the buyer in jargon~~ | `brand` | **struck with `C1.4`, 2026-08-19** (`Q74`) — it was that row duplicated, and both fell to the same evidence |
...
| **C2.6** | ~~The driver is **not** fear of being caught out~~ | **`discussion`** | **STRUCK 2026-08-18** (Q56) |
| **C2.7** | ~~Most clients cannot judge acoustics anyway — told the room sounds good, they will believe it~~ | **`discussion`** | **STRUCK 2026-08-18** (Q56). *Unsourced buyer psychology, and it sits badly against `product-records.md` `R1` — "will this actually change what I hear?" — which reads like risk, not reputation* |
| **C2.8** | ~~The real driver is reliability and reputation~~ | **`discussion`** | **STRUCK 2026-08-18** (Q56) — replaced by C2.14 |
...
| **C2.13** | ~~Integrators who would buy mostly cannot find C-ATS — widely deployed, thinly distributed; the buyer exists, the route is missing~~ | **`discussion`** | **STRUCK 2026-08-18** (Q57): *"again just grossly inflated conversation."* **A diagnosis of why sales are what they are, asserted by the same section that says buyer-truth is parked** |
...
| **C2.23** | ***"The true answer in a lot of cases may simply be that it is simply the option we gave them."*** | `brand` | **Neil's own words, 2026-08-19, and offered as a hypothesis — *"may"*.** **If it is right it moves where the effort goes**, because nothing on that list is doing the persuading: the choice is made when we produce the design, not when the dealer reads copy. *It fits `C6.20` exactly — the design in Cinema Tools Pro forces the whole room and creates the moment to present the elements — and it fits `C2.15`, engage more integrators, which is a reach problem rather than a persuasion problem.* ~~*It is testable against the ledger (`DAT-2`): if C-ATS orders follow design engagements, the hypothesis holds.*~~ **WRONG, corrected 2026-08-19 the same day** (Neil): *"your surmise is nonsensical — if they have paid for design they already chose to go with us."* **A paid design engagement is itself the choice**, so the test measures nothing; the hypothesis is about what appears *inside* an engagement already won. **`DAT-2` killed. The hypothesis stands unfalsified and, from transactions, unfalsifiable** |
