# Acoustics competitor scan — 2026-08-19

*Measured against the eight axes as amended at `Q73`. **Facts only; the reading of them is in
`../group-strategy/competitors.md` § acoustic treatment.** Each cell is what the named source actually showed on
2026-08-19 — nothing inferred, and `not stated` means the page did not say, not that the answer is no.*

**Method and its limits.** Public pages only, fetched 2026-08-19. **Four names, chosen by axis rather than by
reputation** — one per `A5`/`A7` posture the axes asked for. *`competitors.md`'s own discipline applies: a
marketing site shows the shopfront, not the truth.* **A homepage was never taken as evidence of absence** —
where a homepage showed no data, product pages and download indexes were checked before recording it.
...
## Two facts worth recording on their own

**Both published absorption figures exceed 1.0.** GIK's headline is **NRC=1.05**; Primacoustic's 2″ panel reads
**1.07 at 500 Hz**. *A coefficient above unity is a known artefact of the reverberation-room method — edge
diffraction and finite sample area — not necessarily a claim of impossible absorption. Recorded as observed; the
interpretation belongs elsewhere.*

**GIK and C-ATS cite the same standard.** BS EN ISO 354:2003 — GIK at the University of Salford, C-ATS at BSRIA
Bracknell (`../brands/c-ats/product-records.md`). **The standard is not a differentiator between them; what is
published against it differs.**

## Sources, fetched 2026-08-19

- GIK Acoustics Europe — https://www.gikacoustics.net/en-gb
- GIK FlexRange/242 product page — https://www.gikacoustics.com/product/gik-acoustics-242-acoustic-panel/
- GIK downloads index — https://www.gikacoustics.com/downloads/
- RPG Acoustical Systems — https://www.rpgacoustic.com/
- Artnovion — https://www.artnovion.com/
- Primacoustic Broadway engineering data sheet — https://www.primacoustic.com/wp-content/uploads/2023/03/BroadwayWallPanels-EDS-02-2023.pdf
- Primacoustic ASTM C423 test report (ECOScapes, D20 mount) — https://www.primacoustic.com/wp-content/uploads/2023/04/ECOScapes-Slat-Wall-ASTM-C423-D20-Mount-Empty-05_2023.pdf
