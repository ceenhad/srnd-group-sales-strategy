...
`tasks.md` lists 46 tasks and gives each an automation verdict. That verdict is a summary — a task reads
...
> **Resolved by block after the QA (2026-08-08).** The QA graded all 46 tasks (`evidence/2026-08-08-tasks-qa-run.md`).
...
*Verdict shown is the task's, from `tasks.md`. Primitives are marked `machine` or `human` by the table above.*
